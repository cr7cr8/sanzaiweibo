...
import Avatar, { AvartarSmall } from "./Avatar"
...
import createHilightPlugin, { hilightStyleMap } from './HilightPlugin'
...
const mentionPlugin = createMentionPlugin()(["bbb", "aaa", "好好好", "ccklklk;lk;lk;lkc"])
//const mentionPlugin2 = createMentionPlugin2()(["bbb", "aaa", "好好好", "ccklklk;lk;lk;lkc"])

const linkPlugin = createLinkPlugin()()


const customStyleMap = {
    ...hilightStyleMap, ...linkStyleMap,
    stylename1: {
...
const DraftEditor4 = () => {
    ...
    const hilightPlugin = createHilightPlugin(setEditorState)
    ...
    const { userName,uploadContentList } = useContext(UserContext)
   ...
   // const { showPlugin, toggleShow } = useContext(EditorContext)
        ...
        const preHtml_ = stateToHTML(
            es.getCurrentContent(),
            {
                ...
                inlineStyles: {
                    ...
                    HIGHLIGHT: { style: hilightStyleMap.HIGHLIGHT },
    ...
    useEffect(function () {
        ...
        //emojiPlugin.taggingEmoji(editorState)
        //    emojiPlugin.emojiCheckingOperation(editorState)
        // mentionPlugin.taggingMention(editorState)
            ...
            <div style={{
                ...
                {isMobile || <Button
                    onClick={function (e) {
                        ...
                        // insertEmoji(getEmoji(29))
                        // insertEmoji(getEmoji(20))
                    }}
                >表情</Button>}
                <Button
                    onClick={function (e) {
                ...
                <Button
                    onClick={function (e) {
                        ...
                        if (editorState.getSelection().isCollapsed()) {
                            ...
                            hilightPlugin.hiLightOperation(editorState)
                        }
            ...
            >
                <Editor
                    ...
                    plugins={[
                        ...
                        linkPlugin,
                        mentionPlugin,
                        //   isFirefox?mentionPlugin:mentionPlugin2,
                    ...
                    function (e) {
                        ...
                        axios.post(`${url}/article`, {
                            ...
                            .then((response) => {
                                ...
                                axios.get(`${url}/article/${userName}`
